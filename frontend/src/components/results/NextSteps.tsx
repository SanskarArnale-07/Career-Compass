  ...
  return (
    <div className="bg-card border border-border shadow-md rounded-xl p-6 md:p-8 relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col md:flex-row gap-8 items-start">
        ...
        <div className="w-full md:w-auto mt-4 md:mt-0 bg-[#10141A] p-6 rounded-xl border border-border/80 text-center shadow-sm">
          <h4 className="font-bold text-lg mb-2 text-foreground">Personal Guidance</h4>
